...
population = generatePopulation(N=settings["populationSize"], length=100)

# Main algorithm
for generation in range(0, settings["iterations"]):
	...
	print(generation, "/", len(settings["iterations"]))
	population = winners
print("\n Final population:")
print(population)